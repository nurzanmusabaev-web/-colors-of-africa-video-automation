...
FRAMES = [
    ...
    ("0:35", "0_35",
     ...
     [ADULT], BRIGHT, "wide"),
    ("0:42", "0_42",
     "Wide shot of a colony stretch showing natural penguin nest scrapes under low vegetation beside rows of white artificial nest igloos set among sunlit rocks, small distant adult penguins around them.",
     [], BRIGHT, "wide"),
    ("0:49", "0_49",
    ...
    ("1:10", "1_10",
     ...
     [ADULT], BRIGHT, "tele"),
    ("1:17", "1_17",
     "The entrance of a white artificial nest igloo tucked between two boulders, one adult African penguin standing guard at the opening in bright light.",
     [ADULT], BRIGHT, "wide"),
    ("1:24", "1_24",
     "Inside a nest igloo in soft shaded light, two pale bluish-white African penguin eggs resting on a thin lining of dry grass and feathers.",
     [], BRIGHT, "macro"),
    ("1:31", "1_31",
    ...
    ("8:03", "8_03",
     ...
     [ADULT], BRIGHT, "tele"),
    ("8:10", "8_10",
     "Rows of white artificial nest igloos stretching along a stretch of bare, guano-stripped rock under a bright sky.",
     [], BRIGHT, "wide"),
    ("8:17", "8_17",
